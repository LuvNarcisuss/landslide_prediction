...
def ensemble_average_model(model_names):
    ...
    class _AvgWrapper(BaseEstimator, ClassifierMixin):
    ...
    }, _AvgWrapper(trained, weights, best_th)
...
if __name__ == "__main__":
    ...
    ensemble_average_model(model_names)
